    ...
    >
      ...
      >
        ...
        <div className="w-full flex items-end justify-between flex-shrink-0 mt-auto pt-2 z-30 relative">
          ...
          <div className="flex justify-start pointer-events-auto" style={{ transform: isAndroid ? 'scale(0.70)' : 'scale(1)', transformOrigin: 'bottom left' }}>
            <ProfileCard 
              gamertag={gamertag} 
          ...
          <div className="absolute left-1/2 bottom-0 pointer-events-auto" style={{ transform: isAndroid ? 'translateX(-50%) scale(0.80)' : 'translateX(-50%) scale(1)', transformOrigin: 'bottom center' }}>
            <SocialBar socialMedia={socialMedia} />
          </div>

          {/* 3. DERECHA: Status y Settings */}
          <div className="flex justify-end items-center gap-2 md:gap-4 pointer-events-auto" style={{ transform: isAndroid ? 'scale(0.70)' : 'scale(1)', transformOrigin: 'bottom right' }}>
            <div className="hidden sm:block">
              <ServerStatusBox {...serverData} />
            </div>
            <button onClick={() => setShowSettings(true)} className="p-2 sm:p-3 bg-black/40 rounded-xl border border-white/10 hover:bg-white/20 transition-all cursor-pointer">
